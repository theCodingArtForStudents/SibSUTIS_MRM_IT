...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
  ...
  hosts.push_back(HostData(L"ftp.mccme.ru",
                           L"/pub/tex/cd/",
                           L"/pub/tex/cd/"
                           ));
  curHost = 0;

//  vData->push_back( FTPUserData("lackhite.com", "/work/ftp3.php", "/work/post.php") );
//  vData->push_back( FTPUserData("127.0.0.1",
//                                "F:/theCodingArtForStudents/SibSUTIS/MRM/SibSUTIS_MRM_IT/ftpTest/ftp/main.cpp",
//                                "F:/theCodingArtForStudents/SibSUTIS/MRM/SibSUTIS_MRM_IT/ftpTest/ftp/autorun.h"
//                                ));
